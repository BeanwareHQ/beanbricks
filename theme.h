...
static const ThemeSpec THEMESPEC_TBL[] = {
    ...
    [THEME_DARK] = {.theme = THEME_DEFAULT,
                       .bg_color = 0x1d1d1e,
    ...
    [THEME_CTP_LATTE] = {.theme = THEME_CTP_LATTE,
                       .bg_color = 0xeff1f5,
    ...
    [THEME_CTP_FRAPPE] = {.theme = THEME_CTP_FRAPPE,
                       .bg_color = 0x303446,
    ...
    [THEME_CTP_MACCHIATO] = {.theme = THEME_CTP_MACCHIATO,
                       .bg_color = 0x24273a,
    ...
    [THEME_CTP_MOCHA] = {.theme = THEME_CTP_MOCHA,
                       .bg_color = 0x1e1e2e,
